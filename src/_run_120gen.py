"""Script temporal: correr AG con 120 gens capturando fitness/F1 sin tocar el modelo entregado."""
...
import config
config.GA_GENERATIONS = 120

import train_ga
train_ga.GA_GENERATIONS = 120
...
out = ROOT / "outputs" / "_120gen_metrics.json"
